    ...
    <div className="col p-0 h-100">
      <div className="d-flex flex-column h-100">
        <div className="bg-light mb-4 p-3 shadow-sm small">
          ...
          <span className="text-muted">N сообщений в канале</span>
        </div>
        <div id="messages-box" className="chat-messages overflow-auto px-5">
          <div className="text-break mb-2"><b>Пользователь 1</b>: сообщение пользователя 1!</div>
          <div className="text-break mb-2"><b>Пользователь 1</b>: сообщение пользователя 2!</div>
        </div>
