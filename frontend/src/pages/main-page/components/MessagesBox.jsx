    ...
    <div className="col p-0 h-100">
      <div className="d-flex flex-column h-100">
        <div className="bg-light mb-4 p-3 shadow-sm small">
          ...
          <span className="text-muted">{messages.filter((msg) => msg.relatedChannelId === activeChannel.id).length} сообщений в канале</span>
        </div>
        ...
        <div className="mt-auto px-5 py-3">
          <form noValidate="" className="py-1 border rounded-2" onSubmit={handleMsgSubmit}>
            <div className="input-group has-validation">
              <input autoFocus name="body" aria-label="Новое сообщение" placeholder="Введите сообщение..." className="border-0 p-0 ps-2 form-control" ref={msgRef} />
