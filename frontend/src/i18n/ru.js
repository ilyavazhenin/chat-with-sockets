  ...
  translation: {
    ...
    chat: {
      ...
      toast: {
        ...
        cantCreateChannel: 'Не удалось создать канал',
        cantRenameChannel: 'Не удалось переименовать канал',
        cantDeleteChannel: 'Не удалось переименовать канал',
        cantSendMsg: 'Не удалость отправить сообщение',
      },
